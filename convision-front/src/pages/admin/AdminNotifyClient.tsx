...
const AdminNotifyClient: React.FC = () => {
      ...
      {!loading && order && (
        <div className="flex gap-6 items-start">
          ...
          <div className="w-[272px] shrink-0 space-y-4">
            ...
            <Card className="bg-[#f0f4ff] border-[#3a71f7]">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-semibold text-[#3a71f7]">
                  Al registrar
                </CardTitle>
              </CardHeader>
              <CardContent className="text-xs text-[#2d5fd6] leading-relaxed space-y-1.5">
...
export default AdminNotifyClient;
