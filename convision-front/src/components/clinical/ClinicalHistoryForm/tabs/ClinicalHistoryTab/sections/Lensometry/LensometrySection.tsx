...
const LensometrySection: React.FC<SectionProps> = ({ form, serverErrors, renderField, onModalOpen, onModalClose, isModalActive }) => {
  ...
  const fields: FieldDefinition[] = [
    // Lensometry fields - empty labels to avoid duplication
    { 
      name: "lensometria_od", 
      label: "", 
      type: "text",
...
export default LensometrySection; 