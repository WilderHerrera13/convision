...
const KeratometryRefraccionSection: React.FC<SectionProps> = ({ form, serverErrors, renderField, onModalOpen, onModalClose, isModalActive }) => {
  ...
  return (
    <Box sx={{ 
      ...
      {/* First Row - Keratometry, Refraccion, and Test's side by side */}
      <Box sx={{
        display: 'flex',
...
export default KeratometryRefraccionSection; 