...
func (m *MockLaboratoryOrderRepository) AddEvidence(e *domain.LaboratoryOrderEvidence) error {
	return m.Called(e).Error(0)
}

func (m *MockLaboratoryOrderRepository) GetEvidence(orderID uint, transitionType string) ([]*domain.LaboratoryOrderEvidence, error) {
