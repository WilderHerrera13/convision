...
func newLabSvc(labRepo *mocks.MockLaboratoryRepository, orderRepo *mocks.MockLaboratoryOrderRepository) *laboratory.Service {
	return laboratory.NewService(labRepo, orderRepo, &mocks.MockLaboratoryOrderCallRepository{}, &mocks.MockLaboratoryOrderEvidenceRepository{}, &mocks.MockSaleRepository{}, nil, &mocks.MockUserRepository{}, zap.NewNop())
}
