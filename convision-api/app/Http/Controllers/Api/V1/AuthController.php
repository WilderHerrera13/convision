...
class AuthController extends Controller
{
     ...
     *             @OA\Property(property="email", type="string", format="email", example="admin@convision.com"),
     ...
     *                 @OA\Property(property="role", type="string", enum={"admin","specialist","receptionist"})
     *             )
     *         )
     *     ),
     *     @OA\Response(
