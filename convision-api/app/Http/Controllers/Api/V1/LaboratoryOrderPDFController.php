...
class LaboratoryOrderPDFController extends Controller
{
    ...
    /**
     * Generate a laboratory order PDF with lens specifications and return as stream
     *
     * @param int $id
    ...
    public function generate($id)
    {
        ...
        // Generate the PDF using a custom view for laboratory orders
