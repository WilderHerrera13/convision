...
<required_reading>
@~/.copilot/get-shit-done/references/verification-overrides.md
...
@~/.copilot/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@~/.copilot/get-shit-done/references/few-shot-examples/verifier.md
