...
@~/.copilot/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@~/.copilot/get-shit-done/references/ios-scaffold.md
...
@~/.copilot/get-shit-done/references/executor-examples.md
</deviation_rules>
