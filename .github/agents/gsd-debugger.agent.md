...
<required_reading>
@~/.copilot/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@~/.copilot/get-shit-done/references/debugger-philosophy.md
...
@~/.copilot/get-shit-done/references/thinking-models-debug.md
...
- Read @~/.copilot/get-shit-done/references/common-bug-patterns.md
