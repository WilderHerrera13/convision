...
<reference>
@~/.copilot/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `~/.copilot/get-shit-done/references/user-profiling.md` to load:
